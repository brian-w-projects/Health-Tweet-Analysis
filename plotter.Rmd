...
```{r, warning=FALSE}
filenames <- list.files('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\data\\', pattern='*.txt', full.names=TRUE)
raw.data <- filenames %>%
...
ggplot(to.plot, aes(attribute, frequency, fill=target)) +
  ...
  scale_fill_manual(values=c("#771155", "#AA4488", "#CC99BB", "#114477", "#4477AA", "#77AADD", "#117777", "#44AAAA", "#77CCCC", "#117744", "#44AA77", "#88CCAA", "#777711",  "#AAAA44", "#DDDD77", "#774411")
                    ) +
...
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\attributes.png')
```
...
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\tfidf.png')
```
...
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\tfidf_all.png')
```
...
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\sentiments.png')
```
...
data %>%
  ...
  theme(axis.text.x=element_text(angle=-30, vjust=1, hjust=0),
      ...
      legend.background = element_rect(fill='grey95', color='black'),
      legend.key.height = unit(0.6, 'cm'))
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\emotions.png')
```
...
ggsave('C:\\Users\\Brian\\Desktop\\GradClasses\\personal\\health_tweets\\emotions_facet.png')
```
